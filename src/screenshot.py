...
class ScreenshotPreviewCard(QWidget):
    def __init__(self, pixmap, parent=None, zoom_sensitivity=500.0):
        ...
        self.setFixedSize(self.current_logical_width, self.current_logical_height + 30)
    ...
    def _zoom_button_mouse_move(self, event):
        if self.is_resizing_by_zoom_button and event.buttons() == Qt.LeftButton:
            ...
            new_window_width = self.current_logical_width
            new_window_height = self.current_logical_height + 30
...
# 移除 MainApp 类，因为 main.py 中已经有 IntegratedApp 处理了主应用逻辑
